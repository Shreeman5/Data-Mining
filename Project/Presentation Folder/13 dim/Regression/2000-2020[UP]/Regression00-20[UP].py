...
def main():
    ...
    X_test = np.loadtxt('testx2_unpopular.csv', delimiter=',')
    y_test = np.loadtxt('testy2_unpopular.csv', delimiter=',')
    ...
    plt.title('D=13, Train=2000-2019, Test=2020[Unknown Artists], CDF graph')
    plt.show()
