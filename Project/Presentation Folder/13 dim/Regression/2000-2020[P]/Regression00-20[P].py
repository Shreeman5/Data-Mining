...
def main():
    ...
    X_test = np.loadtxt('testx2_popular.csv', delimiter=',')
    y_test = np.loadtxt('testy2_popular.csv', delimiter=',')
    ...
    plt.title('D=13, Train=2000-2019, Test=2020[Known/Popular Artists], CDF graph')
    plt.show()
